...
{
//[PreloadedWindow(EnumWindowPreloadGroup.LOAD_APP)]
  public class WorldUIWindow : ParameterlessWindow
  {
    ...
    /*public AnchorToTarget AddText(string text)
    {
      var result = Assets.Reuse(_uiText);
      result.Text.Value = text;
      AddExisting(result, Vector3.zero);
      return result.GetComponent<AnchorToTarget>();
    }*/
