...
{
    /// <summary>
    /// Pusher (Brutal) movement: up to 2 cells in straight directions (forward, backward, left, right) - no diagonals.
    /// Cross pattern, up to 2 cells.
    /// </summary>
    public sealed class PusherMovement : IMovementStrategy
    {
        public string Id => "pusher";
