...
{
    public class DropBinding : MethodBinding
    {
        public DropBinding(string name, MethodInfo methodInfo) : base(name, methodInfo)
        {
        }
        ...
        public override void Bind(MonoBehaviour controller, GameObject prefab)
        {
            ...
            component.OnDropAction += drag => MethodInfo.Invoke(controller, new object[] { drag });
        }
    }
}
